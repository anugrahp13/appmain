<!-- =============================================== -->
  ...
  <section class="content-header">
    <h1>
      Honor Dosen
      <small>Cetak Rekap Slip Honor Dosen</small>
    </h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-money"></i> Honor Dosen</a></li>
      <li class="active"><a href="#">Rekap Slip Honor Dosen</a></li>
    </ol>
  </section>
  ...
  <section class="content">
    ...
    <!-- Default Box -->
    <div class="box">
      <form class="form-horizontal" action="<?php echo base_url(); ?>d.php/rekapslip/cetak" method="post" target="_blank">
        <!-- Box Body -->
        <div class="box-body">
          <br><br>
          ...
          <div class="form-group">
            <div class="col-sm-offset-4 col-sm-6">
              <div class="checkbox">
                <label>
                  <input type="checkbox" name="rekamcetak" value="1" checked>
                  Rekam cetak laporan
                </label>
              </div>
            </div>
