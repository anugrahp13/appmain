...
<section class="content-header">
  <h1>
    Rencana Kerja
    <a href="<?php echo base_url(); ?>c.php/admin/rencanakerja/tambah" class="btn btn-default btn-xs"><i class="fa fa-plus-circle"></i> Tambah</a>
  </h1>
  <ol class="breadcrumb">
          ...
          <tr>
            ...
            <td class="text-center">
              ...
              if(!empty($keypeserta['id_profil'])){
                $url = base_url()."c.php/admin/rencanakerja/peserta/".$keypeserta['id_profil'];
              }else{$url = "#";}
              ?>
